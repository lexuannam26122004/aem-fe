...
import { Truck, Package, NotepadText, Banknote, Star, Clock, CreditCard, Hourglass, ArrowUpRight } from 'lucide-react'
...
export default function OrderDetailPage() {
    ...
    const [isShowReviewForm, setIsShowReviewForm] = React.useState(false)
    const [selectedProduct, setSelectedProduct] = React.useState<IOrderItem>(null)
    ...
    return (
        <>
                                            ...
                                            {orderDetail.items.map((item, index) => (
                                                ...
                                                >
                                                    ...
                                                    <div className='text-right'>
                                                        ...
                                                        <span
                                                            className='flex items-center justify-end mt-[3px] cursor-pointer'
                                                            onClick={() => {
                                                        ...
                                                        >
                                                            ...
                                                            <ArrowUpRight className='w-4 h-4 ml-1 text-blue-600 hover:text-blue-700' />
                                                        </span>
                                                    </div>
                                                </div>
                                            ))}
            ...
            {selectedProduct && isShowReviewForm && (
                <ReviewFormModal
                    isOpen={isShowReviewForm}
                    onClose={() => setIsShowReviewForm(false)}
