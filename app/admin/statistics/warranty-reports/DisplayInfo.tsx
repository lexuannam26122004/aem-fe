...
function Page() {
    ...
    const revenuePercent = responseData?.data?.percentageChange.revenue
    const ordersPercent = responseData?.data?.percentageChange.orders
    const newCustomersPercent = responseData?.data?.percentageChange.newCustomers
